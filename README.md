...
```yaml
uses: RalfG/python-wheels-manylinux-build@v0.3
with:
...
`RalfG/python-wheels-manylinux-build@v0.3-manylinux2014_aarch64` instead of
`RalfG/python-wheels-manylinux-build@v0.3`.
